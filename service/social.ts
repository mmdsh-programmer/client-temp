...
export const getCustomPostByDomain = async (
  ...
  //   metadata:
  //     "{\"domain\":\"localhost:3000\",\"clientId\":\"18682629g64434d74b0004e8ecb3d3be1\",\"type\":\"clasor\",\"clientSecret\":\"em7b2e01858bent\",\"cryptoSecretKey\":\"340833fec55c3bb3d4687f0b778d995aca29e5c5cf9779d38bf2d7fc7d21fb19\",\"cryptoInitVectorKey\":\"a55f5ffa68b6ff6553f7414ff199a2b3\",\"CUSTOM_POST_TYPE\":\"DOMAIN_BUSINESS\"}",
  //   latitude: 0,
  //   longitude: 0,
  ...
  //       "rateCount": 0
  //   },
  //   "metadata": "{\"domain\":\"pmo-pod-health.dev.ir:3000\",\"clientId\":\"26491i0e984bd2830763a982733515\",\"type\":\"PMO\",\"clientSecret\":\"3de3c530478c4eed\",\"cryptoSecretKey\":\"1f8b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b\",\"cryptoInitVectorKey\":\"9f8e7d6c5b4a3f2e1d0c9b8a7f6e5d4c\",\"CUSTOM_POST_TYPE\":\"DOMAIN_BUSINESS\"}",
  //   "latitude": 0,
  //   "longitude": 0,
  //   "uniqueId": "Pi+9QOpTmVhFzVW2OzID6EE9MjCBcBrCKtyJSUbVv0I=",
  //   "canComment": true,
  //   "canLike": true,
  //   "canRate": true,
  //   "tags": [],
  //   "tagTrees": [],
  //   "data": "{\"--bg-primary-color\":\"#FFFFFF\",\"--bg-secondary-color\":\"#F5F7FA\",\"--bg-tertiary-color\":\"#F2F2F7\",\"--gray-50\":\"#F6F7F8\",\"--gray-100\":\"#EEF0F2\",\"--gray-200\":\"#ECECEE\",\"--gray-300\":\"#CED4D9\",\"--gray-400\":\"#9AA6B1\",\"--gray-500\":\"#71717A\",\"--gray-700\":\"#414147\",\"--gray-800\":\"#1B1B1D\",\"--gray-900\":\"#181C20\",\"--purple-normal\":\"#7446B2\",\"--purple-light\":\"#F1EDF7\",\"--icon-active\":\"#181C20\",\"--icon-hover\":\"#667585\",\"--critical-normal\":\"#E03E1A\",\"--error\":\"#E03E1A\",\"--success-normal\":\"#1F7A37\",\"--success-secondary\":\"#F7FDF8\",\"--info\":\"#0C8CE9\",\"--info-secondary\":\"#E7F5FD\",\"--border-normal\":\"#EEF0F2\",\"--text-primary\":\"#0C0E10\",\"--text-secondary\":\"#667585\",\"--text-hint\":\"#9AA6B1\",\"--text-placeholder\":\"#98A2B3\",\"--text-disabled\":\"#9AA6B1\",\"--text-primary-normal\":\"#7446B2\",\"--text-link\":\"#0C8CE9\", \"logo\": \"\", \"projectDescription\": \"سیستم مدیریت اسناد pmo\", \"projectName\": \"pmo\"}",
  //   "categoryList": [],
  //   "pin": false
  // };
