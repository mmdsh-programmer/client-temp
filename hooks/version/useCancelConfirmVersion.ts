import { cancelConfirmVersionAction } from "@actions/version";
...
const useCancelConfirmVersion = () => {
  ...
  return useMutation({
    mutationKey: ["cancelConfirmVersion"],
    mutationFn: async (values: {
      ...
      const response = await cancelConfirmVersionAction(
        repoId,
        documentId,
        versionId,
      );
...
export default useCancelConfirmVersion;
