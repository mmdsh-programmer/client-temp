...
export const FolderEmptyIcon = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g clipPath="url(#clip0_2127_97673)">
        <mask
          id="mask0_2127_97673"
        ...
        <g mask="url(#mask0_2127_97673)">
          <path d="M200 0H0V150H200V0Z" fill="white" />
          <g filter="url(#filter0_f_2127_97673)">
            <path
              d="M156.312 69.8626C156.312 85.8126 149.75 100.238 139.162 110.55H59.7C49.125 100.225 42.55 85.8126 42.55 69.8626C42.5625 38.4626 68.0376 12.9875 99.4375 12.9875C130.837 12.9875 156.312 38.4626 156.312 69.8626Z"
              fill="url(#paint0_linear_2127_97673)"
            />
          </g>
          <path
            d="M152.2 48.0125H147.4C146.4 45.45 143.925 43.6375 141 43.6375C138.612 43.6375 136.512 44.85 135.3 46.7125C135.275 46.7125 135.25 46.7 135.225 46.6875C134.775 46.575 134.3 46.5 133.812 46.5C132.425 46.5 131.162 47.0125 130.2 47.8625C130.175 47.8625 130.162 47.8875 130.15 47.9C129.562 48.425 129.1 49.075 128.775 49.8125C128.762 49.85 128.75 49.8875 128.737 49.925H128.625C125.987 49.925 123.85 52.0624 123.85 54.6999H158.925C158.925 50.9999 155.937 48.0125 152.237 48.0125H152.2Z"
            fill="white"
          />
          <path
            d="M187.5 102.512H12.5V137.512H187.5V102.512Z"
            fill="url(#paint1_radial_2127_97673)"
          />
          <path
            d="M59.3874 70.975H55.3124C54.2749 68.8375 52.0874 67.3625 49.5499 67.3625C46.2999 67.3625 43.6124 69.8001 43.2124 72.9376H41.1124C38.4124 72.9376 36.2249 75.125 36.2249 77.825H66.2249C66.2249 74.0375 63.1624 70.9875 59.3874 70.9875V70.975Z"
            fill="white"
          />
          <path
          ...
          />
          <path
            d="M128.313 91.4999H72.1L60.55 56.7001C59.325 53.0251 61.875 49.1626 65.5125 49.1626H82.275C85.275 49.1626 88.175 50.2501 90.5125 52.2626L93.5125 54.8251C95.85 56.8251 98.75 57.9251 101.75 57.9251H132C135.638 57.9251 138.188 61.7876 136.963 65.4626L128.325 91.4999H128.313Z"
            fill="#D3C7E5"
          />
          <path
            d="M83.55 70.475C83.575 70.05 83.6125 69.6375 83.65 69.225"
            stroke="#B096D6"
            strokeMiterlimit="10"
            strokeLinecap="round"
            strokeDasharray="2 2"
          />
          <path
            d="M83.975 66.8004C85.1875 59.6754 88.6 54.0879 93.2625 49.8254C97.7125 45.7504 106.512 40.7129 110.137 47.3879C112.625 51.9754 109.787 60.4004 105.025 60.7504C100.525 61.0879 95.6375 44.8129 101.612 34.6129C102.625 32.8754 104.375 30.8129 106.112 29.1879"
            stroke="#B096D6"
            strokeMiterlimit="10"
            strokeLinecap="round"
            strokeDasharray="2 2"
          />
          <path
            d="M107.025 28.3751C107.363 28.0876 107.688 27.8376 108 27.6001"
            stroke="#B096D6"
            strokeMiterlimit="10"
            strokeLinecap="round"
            strokeDasharray="2 2"
          />
          <path
            d="M122.7 112.175H74.7874C71.225 112.175 68.0625 109.8 66.8625 106.237L56.5625 75.475C55.2625 71.6 57.975 67.525 61.8375 67.525H135.625C139.5 67.525 142.2 71.6 140.9 75.475L130.6 106.237C129.413 109.8 126.238 112.175 122.675 112.175H122.7Z"
            fill="white"
          />
          <g filter="url(#filter1_f_2127_97673)">
            <path
              d="M128.125 99.9751C126.938 103.538 122.513 105.913 118.95 105.913H78.5375C74.9749 105.913 70.5624 103.538 69.3624 99.9751L57.5374 69.6125C56.3374 71.15 55.8624 73.3001 56.5624 75.4001L66.8624 106.163C68.0499 109.725 71.2249 112.1 74.7874 112.1H122.7C126.263 112.1 129.425 109.725 130.625 106.163L140.925 75.4001C141.625 73.3001 141.15 71.15 139.95 69.6125L128.125 99.9751Z"
              fill="#F2EDF9"
            />
          </g>
          <path
            d="M136.962 65.45L136.262 67.55C136.062 67.525 135.85 67.5125 135.637 67.5125H64.1375L61.2875 58.9501H135.037C136.862 60.3376 137.787 62.9376 136.962 65.45Z"
            fill="url(#paint2_linear_2127_97673)"
          />
        </g>
      </g>
      <defs>
        <filter
          id="filter0_f_2127_97673"
          x="22.55"
          y="-7.01245"
          width="153.762"
          height="137.562"
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="10"
            result="effect1_foregroundBlur_2127_97673"
          />
        </filter>
        <filter
          id="filter1_f_2127_97673"
          x="50.2366"
          y="63.6125"
          width="97.0142"
          height="54.4875"
