...
const SearchContentResult = ({ repoId }: { repoId: number }) => {
  ...
  const getSearchParam = useCategoryStore((state) => {
    return state.categorySearchContentParam;
  });
  ...
  return (
    <div
      className="dialog-content flex max-h-64 min-h-[100px] flex-col overflow-y-auto px-2"
      onScroll={onScroll}
      ref={listInnerRef}
    >
