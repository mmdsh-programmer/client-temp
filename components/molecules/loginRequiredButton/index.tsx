  ...
  return (
    <div className="h-full w-full flex flex-col justify-center items-center">
      ...
      <Button
        placeholder=""
        variant="text"
        className="sm:!px-10 py-5 lg:mt-0 sm:bg-purple-normal text-white font-iranYekan !max-h-[unset] bg-transparent flex justify-center items-center gap-2 w-[50%] xs:w-[100px] h-12 xs:h-8 px-3 xs:px-1 rounded-lg"
        onClick={handleClick}
      >
