  ...
  return (
    <div className="repo-types-mobile-view w-full px-4 absolute bottom-0 xs:hidden min-h-16 h-16 bg-primary border-normal">
      <div className="flex justify-between items-center h-full">
        <div
          className={`repo-types-mobile-view__myRepo flex flex-col items-center cursor-pointer ${getRepoGroup === ERepoGrouping.MY_REPO ? "text-primary stroke-icon-active" : "text-gray-400 stroke-gray-400"}`}
          onClick={() => {
        ...
        <div
          className={`repo-types-mobile-view__bookmarkRepo flex flex-col items-center cursor-pointer ${getRepoGroup === ERepoGrouping.BOOKMARK_REPO ? "text-primary stroke-icon-active" : "text-gray-400 stroke-gray-400"}`}
          onClick={() => {
        ...
        <div
          className={`repo-types-mobile-view__accessRepo flex flex-col items-center cursor-pointer ${getRepoGroup === ERepoGrouping.ACCESS_REPO ? "text-primary stroke-icon-active" : "text-gray-400 stroke-gray-400"}`}
          onClick={() => {
        ...
        <div
          className={`repo-types-mobile-view__archiveRepo flex flex-col items-center cursor-pointer ${getRepoGroup === ERepoGrouping.ARCHIVE_REPO ? "text-primary stroke-icon-active" : "text-gray-400 stroke-gray-400"}`}
          onClick={() => {
