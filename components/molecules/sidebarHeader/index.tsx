  ...
  return (
    <Link href="/" className="w-full">
      <Card
        ...
        className="sidebar-header shadow-none px-3 py-2 text-primary_normal hover:text-white rounded-md cursor-pointer hover:bg-tertiary w-full border-[1px] border-gray-200"
      >
        <div className="flex items-center">
          <div className="w-10 h-10 min-w-10 min-h-10 rounded-md p-1 bg-tertiary">
            {domainInfo?.logo ? (
              <ImageComponent
                className="h-8 w-8"
                width={32}
