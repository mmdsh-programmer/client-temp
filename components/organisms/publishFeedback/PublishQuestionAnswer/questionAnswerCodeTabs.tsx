...
const QuestionAnswerCodeTabs = (props: IProps) => {
  ...
  if (mode === "pdf") {
    return (
      <div className="clasor-code-container pdf-mode my-4">
        {link ? (
          <a
            href={link}
            target="_blank"
  ...
  return (
    <div className="clasor-code-container my-4">
      {link ? (
        <a
          href={link}
          target="_blank"
...
export default QuestionAnswerCodeTabs;
