...
import { ChatIcon, ChevronLeftIcon, DeleteIcon, EditIcon, TickIcon } from "@components/atoms/icons";
import RenderIf from "@components/atoms/renderIf";
import { IQuestion } from "@interface/qa.interface";
import { Button, Card, CardBody, CardFooter, CardHeader, Collapse } from "@material-tailwind/react";
    ...
    <>
      ...
      >
        ...
        <CardBody className="word-break p-0" {...({} as React.ComponentProps<typeof CardBody>)}>
          <QuestionAnswerContentPreview content={questionItem.content} className="text-sm" />
        </CardBody>
        <CardFooter
