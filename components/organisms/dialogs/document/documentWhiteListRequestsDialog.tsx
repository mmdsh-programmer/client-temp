...
import useGetWhiteListRequests from "@hooks/document/useGetWhiteListRequests";
...
const DocumentWhiteListRequestsDialog = ({ setOpen }: IProps) => {
  ...
  const {
    ...
    hasNextPage,
    fetchNextPage,
  } = useGetWhiteListRequests(repo!.id, selectedDocument!.id, 10);
    ...
    >
      ...
      >
        {isLoading ? (
          ...
          <>
            <div className="white-list-request-list flex flex-col overflow-h-auto gap-3">
...
export default DocumentWhiteListRequestsDialog;
