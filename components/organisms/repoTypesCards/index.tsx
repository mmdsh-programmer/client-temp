...
const RepoTypesCards = () => {
  ...
  const repoTypeData = [
    {
      ...
      icon: <MyFolderIcon className="h-full w-full" />,
      onClick: () => {
    ...
    },
    {
      ...
      icon: <FolderShareIcon className="h-full w-full" />,
      onClick: () => {
    ...
    },
    {
      ...
      icon: <FolderBookmarkIcon className="h-full w-full" />,
      onClick: () => {
    ...
    },
    {
      ...
      icon: <ArchiveIcon className="h-full w-full" />,
      onClick: () => {
  ...
  return (
    <div
      className={`hidden xs:flex gap-4 flex-wrap min-w-full`}
    >
