FROM nrp.devpod.ir:8138/repository/applicationplatform-docker-hosted/node:18.12.0 as builder
...
FROM nrp.devpod.ir:8138/repository/applicationplatform-docker-hosted/node:18.12.0 as production
WORKDIR /app
